		...
		<div className=" relative w-full px-10 md:px-16 lg:px-32 my-10 md:my-20 py-10 ">
			<div className="flex flex-col sm:flex-row gap-10">
				...
				<div>
					...
					<div className="text-[#4D4D4D] text-[9px] md:text-sm">
						<p><a href="">Home</a></p>
				...
				<div className='w-full sm:w-fit'>
					...
					<div className='w-full'>
						...
						<input type="email" name='email' placeholder='example@gmail.com' className="px-4 py-1.5 bg-[#1F1F1F] text-white outline-none focus::outline-none text-[9px] md:text-sm w-full" />
					</div>

					<div>
						<button type='submit' className="bg-[#FFDB00] rounded-xl text-black px-4 py-2 my-3 text-[9px] md:text-sm" ><a href="">Subscribe</a></button>
					</div>
				</div>
			</div>
			...
			<img src={ringed} alt="" className="absolute bottom-0 right-10 hidden md:block" />
		</div>
	);
}
