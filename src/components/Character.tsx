            ...
            <div className='w-full grid grid-rows-3 sm:grid-cols-3 sm:grid-rows-1  items-center gap-5 my-3'>
                <div className='border-[3px] border-[#FFDB00] rounded-lg p-3 h-full'>
                    ...
                    <div className='flex flex-col gap-4 mt-[10%]'>
                        ...
                        <p className="text-[9px] md:text-sm text-[#3F3F3F]  font-bold">Playas Robert, a simple yet stubborn woodsman, skilled in survival, mechanics and firearms. Ex-military? Nope. Everyone is a badass in order to survive in the woods of Lupinshire.</p>
                    </div>
                </div>
                ...
                <div className='border-[3px] border-[#FFDB00] rounded-lg p-3 h-full'>
                    ...
                    <div  className='flex flex-col gap-4 mt-[10%]'>
                        ...
                        <p className="text-[9px] md:text-sm text-[#3F3F3F]  font-bold">A typical 14yo teenage girl, bored of the woods and awaiting her next visit to the village, or better, the big city. </p>
                    </div>
                </div>
                ...
                <div className='border-[3px] border-[#FFDB00] rounded-lg p-3 h-full'>
                    ...
                    <div  className='flex flex-col gap-4 mt-[10%]'>
                        ...
                        <p className="text-[9px] md:text-sm text-[#3F3F3F]  font-bold">Your fancy city wife loved you enough to stay with you, away from the comfort and services of Ultrapolis. Armed with her shotgun, she will do her best to keep your children safe, lest you allow a fowl creature to get inside, </p>
                    </div>
                </div>
            </div>
        </div>
